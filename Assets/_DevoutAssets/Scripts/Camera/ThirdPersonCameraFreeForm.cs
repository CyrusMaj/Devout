...
[RequireComponent(typeof(ThirdPersonCameraCore))]
public class ThirdPersonCameraFreeForm : MonoBehaviour
{
	...
	private ThirdPersonCameraCore cameraController;

	public void Start()
	{
		//
//		GameController.GC.mainCamera = GetComponent<Camera>();

		cameraController = GetComponent<ThirdPersonCameraCore>();
...
//		}
	...
	public void Update()
	{
		...
		if (cameraEnabled && GameController.GC.GetIsControlAllowed() && cameraController.target != null)
		{

...
/// DEPRECATED
/// 
/// Copy of ThirdPersonOrbitCam
/// For LevelTester Prefab only
/// For Dev purpose only
/// </summary>
public class LevelTesterCamera : MonoBehaviour
{
...
//
//	private LevelTesterMovementControl playerControl;
...
//		//initialize
//		enabled = true;
//		playerControl = player.GetComponent<LevelTesterMovementControl> ();
...
//			if (!player.IsChildOf(hit.transform.root) && !hit.transform.GetComponent<Collider> ().isTrigger) {
...
//			if (!player.IsChildOf(hit.transform.root) && hit.transform.root != transform && !hit.transform.GetComponent<Collider> ().isTrigger) {
//				return false;
//			}
//		}
//		return true;

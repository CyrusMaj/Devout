#pragma warning disable 1591
	...
	public enum RangeOperator {None, Equals, GreaterThan, GreaterThanOrEquals, LessThan, LessThanOrEquals};
        ...
        {
			//return IsVisible(from, to, range, LayersManagerComponent.instance.obstacleLayer);
			return IsVisible(from, to, range, 1 << 8);
		}

...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter222 : MonoBehaviour
	{
		...
		{
			//
			//			print ("m_ForwardAmount : " + m_ForwardAmount + ", m_TurnAmount : " + m_TurnAmount);
			// update the animator parameters
			m_Animator.SetFloat (_hashFoward, m_ForwardAmount, 0.1f, Time.deltaTime);
			m_Animator.SetFloat (_hashTurn, m_TurnAmount, 0.1f, Time.deltaTime);
			...
			if (m_IsGrounded) {
				m_Animator.SetFloat (_hashJumpLeg, jumpLeg);
			}
		...
		public void Set_hanging (bool new_hanging)
		{
			_hanging = new_hanging;
		}
